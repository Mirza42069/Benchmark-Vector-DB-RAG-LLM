"""
Document Ingestion for Qdrant vector database.
"""
...
def recreate_collection(collection_name: str) -> QdrantVectorStore:
...
def ingest_collection(collection_name: str, documents):
    ...
    ids = [i + 1 for i in range(len(documents))]
    batch_size = 50
    total_batches = (len(documents) + batch_size - 1) // batch_size

    print(f"\nAdding documents to Qdrant collection '{collection_name}'...")
