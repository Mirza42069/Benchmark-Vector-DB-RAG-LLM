...
# Page config
st.set_page_config(
    page_title="ITS Helpdesk Chatbot - Pinecone",
    page_icon="🤖",
    layout="wide"
)
...
st.caption("Powered by Pinecone Vector Database")

# Sidebar
with st.sidebar:
    st.header("⚙️ Configuration")
    st.info(f"**Vector Database:** Pinecone")
...
# Footer
st.divider()
st.caption("🎓 ITS Helpdesk Chatbot | Using Pinecone Vector Database | Powered by Ollama")